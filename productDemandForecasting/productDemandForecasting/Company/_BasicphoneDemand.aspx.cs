...
{
    public partial class _BasicphoneDemand : System.Web.UI.Page
    {
        ...
        {
            string FileName = "BasicphonesTestingDataset.xls";

            string Extension = ".xls";

            string FolderPath = ConfigurationManager.AppSettings["FolderPath"];

            string _Location = "BasicphonesTestingDataset";
        ...
        protected void btnPrediction_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (tabData.Rows.Count > 0)
                {
                    ...
                    cell2.Text = "<b>battery</b>";
                    mainrow.Controls.Add(cell2);

                    TableCell cell3 = new TableCell();
                    cell3.Text = "<b>color</b>";
                    mainrow.Controls.Add(cell3);

                    TableCell cell4 = new TableCell();
                    cell4.Text = "<b>camera</b>";
                    ...
                    for (int i = 0; i < tabData.Rows.Count; i++)
                    {
                        ...
                        string _data = tabData.Rows[i]["fm"].ToString() + "," + tabData.Rows[i]["battery"].ToString() + "," +
                            tabData.Rows[i]["color"].ToString() + "," + tabData.Rows[i]["camera"].ToString() + "," +
                            tabData.Rows[i]["ram"].ToString() + "," + tabData.Rows[i]["storage"].ToString() + "," +
                            tabData.Rows[i]["dualsim"].ToString();
                        ...
                        cell1.Width = 100;
                        _cell1.Text = tabData.Rows[i]["fm"].ToString();
                        row.Controls.Add(_cell1);

                        TableCell _cell2 = new TableCell();
                        _cell2.Width = 100;
                        _cell2.Text = tabData.Rows[i]["battery"].ToString();
                        row.Controls.Add(_cell2);

                        TableCell _cell3 = new TableCell();
                        _cell3.Width = 100;
                        _cell3.Text = tabData.Rows[i]["color"].ToString();
                        row.Controls.Add(_cell3);

                        TableCell _cell4 = new TableCell();
                        _cell4.Width = 100;
                        _cell4.Text = tabData.Rows[i]["camera"].ToString();
        ...
        protected void btnResults_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("_BasicphoneResults.aspx");
        }               
