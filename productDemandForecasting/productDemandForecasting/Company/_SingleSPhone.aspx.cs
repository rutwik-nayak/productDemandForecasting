...
{
    public partial class _SingleSPhone : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                string _data = txtOS.Value + "," + txtColor.Value + "," +
                              txtPCamera.Value + "," + txtSCamera.Value + "," +
                              txtRAM.Value + "," + txtStroage.Value + "," +
                              txtSpeed.Value + "," + txtDualSim.Value + "," +
                              txtDisplay.Value;
